...
/**
 * Mathematical operation as AST node.
 */
abstract class OperationNode extends AbstractBinaryNode<Operation> {

	/**
	 * @param left  the left ast
	 * @param op    operand of this node
	 * @param right the right node
	 */
	OperationNode(AST<?> left, Operation op, AST<?> right) {
		super(left, op, right);
	}
